...
PM_START_TEXT = """
*Hello {} !*
✪ I'm an anime-theme management bot [✨](https://telegra.ph/file/de19c6a0ebda89a71678d.jpg)
────────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
────────────────────────
...
def emiko_about_callback(update, context):
    ...
    if query.data == "emiko_":
        ...
        query.message.edit_text(
            text="*๏ Maternal support chats*"
            f"\nJoin My Support Group/Channel for see or report a problem on {dispatcher.bot.first_name}.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Support", url="https://t.me/withyohaneshere"),
                    InlineKeyboardButton(text="Updates", url="https://t.me/withyohaneshere"),
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="emiko_"),
